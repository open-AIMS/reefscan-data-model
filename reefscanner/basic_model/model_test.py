...
for id in basic_model.surveys_data:
    print(basic_model.surveys_data[id].finish_lat)
...
# for id in basic_model.archived_surveys:
#     print(id)
#     print(basic_model.archived_surveys[id].to_json())
